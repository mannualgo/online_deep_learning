...
from .models import load_model, Classifier
...
#     model_best_params["linear"] = {"num_epoch": 50,"lr":1e-3 }
#     model_best_params["mlp"] = {"num_epoch": 75,"lr":1e-2 }
#     model_best_params["mlp_deep"] = {"num_epoch": 75,"lr":1e-1 }
#     model_best_params["mlp_deep_residual"] = {"num_epoch": 75,"lr":1e-2 }
...
#     num_epoch = model_best_params[model_name]["num_epoch"]
#     lr = model_best_params[model_name]["lr"]
...
#             metrics["train_acc"].append(compute_accuracy(pred_lbl,label))
...
#                 img, label = img.to(device), label.to(device)
#                 pred_lbl_val = model(img)
#                 # TODO: compute validation accuracy
#                 metrics["val_acc"].append(compute_accuracy(pred_lbl_val,label.float()))
